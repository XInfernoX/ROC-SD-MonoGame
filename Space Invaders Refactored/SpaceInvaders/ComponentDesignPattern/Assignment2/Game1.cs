...
namespace ComponentDesignPattern.Assignment2
{
    public class Game1 : Game
    {
        ...
        private Rotater[] _rotateTestObjects;
        private Scaler[] _scaleTestObjects;
        ...
        protected override void LoadContent()
        {
            ...
            //RotationTestSetup
            _rotateTestObjects = new Rotater[9];
            ...
            for (int x = 0, i = 0; x < 3; x++)
            {
                for (int y = 0; y < 3; y++, i++)
                {
                    ...
                    _rotateTestObjects[i] = new Rotater($"RotatorTest{i}", rotatorTransform, rotatorRenderer, 2);
                }
            }

            //ScaleTestSetup
            _scaleTestObjects = new Scaler[4];
            ...
            _scaleTestObjects[0] = new Scaler("Scaler1", scaleTestTransform1, scaleTestRenderer1, 1);
            ...
            _scaleTestObjects[1] = new Scaler("Scaler2", scaleTestTransform2, scaleTestRenderer2, 2);
            ...
            _scaleTestObjects[2] = new Scaler("Scaler3", scaleTestTransform3, scaleTestRenderer3, 3);
            ...
            _scaleTestObjects[3] = new Scaler("Scaler4", scaleTestTransform4, scaleTestRenderer4, 4);

...
namespace SpaceInvadersRefactored
{
    public class SpaceInvadersGame : RefactoredGameBase
    {
        ...
        protected override void LoadContent()
        {
            ...
            _background = new CoreRefactored.GameObject(this, "background", Vector2.Zero, Vector2.Zero, backgroundRenderer);
            ...
            _player = new CoreRefactored.GameObject(this, "player", playerSpawnPosition, new Vector2(0.5f, 0.5f), 0, Vector2.One, playerBehaviour, playerCollider, playerRenderer, playerMovement, playerLaserShooter);
            ...
            _alienWave1 = new CoreRefactored.GameObject(this, "Alien Wave 1", alienWaveBehaviour);

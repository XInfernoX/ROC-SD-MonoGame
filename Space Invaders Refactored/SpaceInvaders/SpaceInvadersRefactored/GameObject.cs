...
namespace SpaceInvadersRefactored
{
    public class GameObject : IDisposable
    {
        ...
        /// <summary>Gets called upon Destroying this GameObject, it cleans up itself by Destroying and removing all Components and finally itself from the _game</summary>
        public void Dispose()
        {

    ...
    public class GameObject : IDisposable
    {
        ...
        public virtual void Draw(SpriteBatch pSpriteBatch)
        {
            if (_active)
            {
                ...
                pSpriteBatch.Draw(_texture, _position, null, Color.White, _rotation, scaledOrigin, _scale, SpriteEffects.None, 0);
            }
        }
        ...
        {
            return new Vector2(MathF.Sin(pDegrees), -MathF.Cos(_rotation));
        }

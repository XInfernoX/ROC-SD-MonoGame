...
namespace CoreRefactored
{
    public abstract class RefactoredGameBase : Game
    {
        ...
        private readonly List<CoreRefactored.GameObject> _gameObjects;
        ...
        protected RefactoredGameBase()
        {
            ...
            _gameObjects = new List<CoreRefactored.GameObject>();
        }
        ...
        public void AddGameObject(CoreRefactored.GameObject pNewGameObject)
        {
            _gameObjects.Add(pNewGameObject);
        }
        public void RemoveGameObject(CoreRefactored.GameObject pGameObject)
        {
        ...
        protected void CollisionCheckAllGameObjects(GameTime pGameTime)
        {
            ...
            {
                CoreRefactored.GameObject outerGameObject = _gameObjects[outerI];

                for (int innerI = outerI + 1; innerI < _gameObjects.Count; innerI++)
                {
                    CoreRefactored.GameObject innerGameObject = _gameObjects[innerI];

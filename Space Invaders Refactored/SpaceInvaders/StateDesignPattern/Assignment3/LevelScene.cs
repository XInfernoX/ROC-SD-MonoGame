...
namespace StateDesignPattern.Assignment3
{
    ...
    {
        public LevelScene(Game1 pGame, string pSceneName, Player pPlayer) : base(pGame, pSceneName, pPlayer)
        {
        }
        ...
        protected override void CreateObjects(ContentManager pContent, Viewport pViewPort)
        {
            ...
            //Buttons
            AddGameObject(new MenuButton(new Vector2(viewPort.Width, 0), _game, _game.ButtonColorScheme, "Menu"));
            ...
            AddGameObject(new Enemy(new Vector2(viewPort.Width / 2.0f, third), pContent.Load<Texture2D>("Enemy"), 100, wayPoints, _player, 100));

            Gate gate = new Gate(new Vector2(pViewPort.Width / 2.0f, 50), _player, _game, "Level2");
            AddGameObject(gate);
        }
    }
    ...
    public class Level2Scene : SceneBase
    {
        ...
        protected override void CreateObjects(ContentManager pContent, Viewport pViewPort)
        {
            Gate level1Gate = new Gate(new Vector2(pViewPort.Width / 2.0f, 50), _player, _game, "Level1");
    ...
    public class Level3Scene : SceneBase
    {
        ...
        protected override void CreateObjects(ContentManager pContent, Viewport pViewPort)
        {
            ...
            Gate level2Gate = new Gate(new Vector2(pViewPort.Width / 2.0f, 50), _player, _game, "Level2");
            AddGameObject(level2Gate);

            Gate level4Gate = new Gate(new Vector2(pViewPort.Width / 2.0f, 50), _player, _game, "Level4");
